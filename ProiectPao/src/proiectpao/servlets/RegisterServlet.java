...
public class RegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(session.getAttribute("loginedUser") != null) {
        	...
        	RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/webPages/register.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (userName == null || password == null || userName.length() <= 5 || password.length() <= 6 || email == null || ptr.matcher(email).matches() == false) {
            hasError = true;
            ...
            try {
                ...
                if (user != null) {
                    hasError = true;
                    errorString = "Numele este deja luat!";
                } else if (DBUtils.findEmail(conn, email) != null) {
                	hasError = true;
                    errorString = "Email existent!";
                }
